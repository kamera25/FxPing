...
const Header: React.FC<HeaderProps> = ({ showSettings, setShowSettings }) => {
    return (
        <header>
            <div style={{ fontWeight: 'bold', letterSpacing: '1px', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '14px' }}>
                <img src="/icon.png" alt="FxPing Logo" style={{ width: '20px', height: '20px' }} />
                FxPing
            </div>
            <button
